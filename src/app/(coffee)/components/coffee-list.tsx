...
export const CoffeeList = () => {
  return (
    ...
    <section className="w-full py-8 max-[625px]:py-32 max-[516px]:py-64 max-[476px]:py-72 max-[417px]:py-[300px] max-[452px]:py-[350px] max-[416px]:py-[400px] bg-base-background max-[1120px]:p-8 pb-20">
