      ...
      <div className="w-full max-w-[70rem] mr-auto ml-auto max-[1120px]:p-8">
        <header className="flex flex-col items-center justify-center py-10">
          <h1 className="text-5xl font-bold mb-4 font-baloo text-base-title">
            Peça o que quiser com{" "}
            <span className="text-brand-yellow">Wagon</span>
          </h1>
          <p className="text-center text-lg text-gray-600 mb-8">
            Entregamos tudo o que você deseja diretamente na porta da sua casa!
            De cafés especiais e selecionados a deliciosos pratos dos melhores
        ...
        <div className="flex justify-center py-16">
          ...
          >
            <h2 className="font-baloo font-bold text-regular-lg">
              Coffee Wagon
            </h2>
